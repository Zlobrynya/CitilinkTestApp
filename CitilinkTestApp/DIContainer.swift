...
public enum DIContainer {
    ...
    public static let endpoints = Plist<Endpoints>(resourceName: "Endpoints", bundle: .main).decode()!
    /// External Key needed by the Core module.
    public static let apiKeys = Plist<ApiKeys>(resourceName: "ApiKeys", bundle: .main).decode()!
}
